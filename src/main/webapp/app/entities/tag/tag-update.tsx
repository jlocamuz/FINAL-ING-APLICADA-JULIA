  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="appApp.tag.home.createOrEditLabel" data-cy="TagCreateUpdateHeading">
            <Translate contentKey="appApp.tag.home.createOrEditLabel">Create or edit a Tag</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('appApp.tag.name')}
                id="tag-name"
                name="name"
                data-cy="name"
                type="text"
