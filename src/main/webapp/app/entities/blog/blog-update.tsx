  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="appApp.blog.home.createOrEditLabel" data-cy="BlogCreateUpdateHeading">
            <Translate contentKey="appApp.blog.home.createOrEditLabel">Create or edit a Blog</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('appApp.blog.name')}
                id="blog-name"
                name="name"
                data-cy="name"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('appApp.blog.handle')}
                id="blog-handle"
                name="handle"
                data-cy="handle"
                type="text"
              ...
              />
              <ValidatedField id="blog-user" name="user" data-cy="user" label={translate('appApp.blog.user')} type="select">
                <option value="" key="0" />
                {users
