  ...
  return (
    <div>
      <h2 id="blog-heading" data-cy="BlogHeading">
        <Translate contentKey="appApp.blog.home.title">Blogs</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="appApp.blog.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/blog/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="appApp.blog.home.createLabel">Create new Blog</Translate>
          </Link>
        </div>
      </h2>
        ...
        {blogList && blogList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="appApp.blog.id">ID</Translate>
                </th>
                <th>
                  <Translate contentKey="appApp.blog.name">Name</Translate>
                </th>
                <th>
                  <Translate contentKey="appApp.blog.handle">Handle</Translate>
                </th>
                <th>
                  <Translate contentKey="appApp.blog.user">User</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="appApp.blog.home.notFound">No Blogs found</Translate>
            </div>
          )
        )}
      </div>
