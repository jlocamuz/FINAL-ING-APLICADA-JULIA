    ...
    <Row>
      <Col md="8">
        <h2 data-cy="postDetailsHeading">
          <Translate contentKey="appApp.post.detail.title">Post</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="title">
              <Translate contentKey="appApp.post.title">Title</Translate>
            </span>
          </dt>
          <dd>{postEntity.title}</dd>
          <dt>
            <span id="content">
              <Translate contentKey="appApp.post.content">Content</Translate>
            </span>
          </dt>
          <dd>{postEntity.content}</dd>
          <dt>
            <Translate contentKey="appApp.post.blog">Blog</Translate>
          </dt>
          <dd>{postEntity.blog ? postEntity.blog.name : ''}</dd>
          <dt>
            <Translate contentKey="appApp.post.tag">Tag</Translate>
          </dt>
          <dd>
            {postEntity.tags
