  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="appApp.post.home.createOrEditLabel" data-cy="PostCreateUpdateHeading">
            <Translate contentKey="appApp.post.home.createOrEditLabel">Create or edit a Post</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('appApp.post.title')}
                id="post-title"
                name="title"
                data-cy="title"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('appApp.post.content')}
                id="post-content"
                name="content"
                data-cy="content"
                type="textarea"
              ...
              />
              <ValidatedField id="post-blog" name="blog" data-cy="blog" label={translate('appApp.post.blog')} type="select">
                <option value="" key="0" />
                {blogs
              ...
              <ValidatedField label={translate('appApp.post.tag')} id="post-tag" data-cy="tag" type="select" multiple name="tags">
                <option value="" key="0" />
                {tags
